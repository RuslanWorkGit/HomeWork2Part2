...
typealias Weather = (cityName: String, tempKel: Double, tempMinKel: Double, tempMaxKel: Double)
...
for index in 0...cityNames.count - 1 {

    let weatherInfo: Weather = (
        cityName: cityNames[index], // записуємо назву міста
        tempKel: Double(arc4random() % 30) + kelvinZero, // генеруємо випадкове значення температури у Кельвінах
        tempMinKel: Double(arc4random() % 30) + kelvinZero, // генеруємо випадкове значення температури у Кельвінах
        tempMaxKel: Double(arc4random() % 30) + kelvinZero // генеруємо випадкове значення температури у Кельвінах
    )
...
for index in 0..<cityNames.count {
    ...
    let celsius = NSString(format: "%.1f", weatherInfo.1 - 273.5)
    let kelvin = String(format: "%.2f", (weatherInfo.tempKel * (9.0/5.0) - 459.67))
    let celsiusMin = NSString(format: "%.1f", weatherInfo.tempMinKel - 273.5)
    let kelvinMin = String(String(format: "%.2f", (weatherInfo.tempMinKel * (9.0/5.0) - 459.67)))
    let celsiusMax = NSString(format: "%.1f", weatherInfo.tempMaxKel - 273.5)
    let kelvinMax = String(String(format: "%.2f", (weatherInfo.tempMaxKel * (9.0/5.0) - 459.67)))

    print("\n\(city):")
    print("t: \(celsius) C")
    print("t: \(kelvin) F")
    print("min t: \(celsiusMin) C / \(kelvinMin) F")
    print("max t: \(celsiusMax) C / \(kelvinMax) F")
}
print("\n-----------------------------")
print("\n\n")
...
for index in 0..<weatherInCities.count {
    ...
    let weatherInfo = weatherInCities[index]
    let city = weatherInfo.cityName
    let forengayt = (weatherInfo.tempKel * (9.0/5.0) - 459.67)
    print("\n\(city):\nt: \(String(format: "%.2f", forengayt)) F")
}
print("\n-----------------------------")
